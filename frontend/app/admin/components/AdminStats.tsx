  ...
  if (loading) {
    return (
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="bg-[#E8EDE1] p-6 border-4 border-[#556B2F] shadow-brutal">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <div className="bg-[#E8EDE1] p-6 border-4 border-[#556B2F] shadow-brutal">
        ...
        <p className="text-4xl font-black text-[#556B2F]">{stats.totalDocuments}</p>
      </div>
      ...
      <div className="bg-[#E8EDE1] p-6 border-4 border-[#556B2F] shadow-brutal">
        ...
        <p className="text-4xl font-black text-[#556B2F]">{stats.totalOrganizations}</p>
      </div>
      ...
      <div className="bg-[#E8EDE1] p-6 border-4 border-[#556B2F] shadow-brutal">
        ...
        <p className="text-4xl font-black text-[#556B2F]">{stats.pendingApplications}</p>
      </div>
    </div>
  );
};
