  ...
  return (
    <div className="min-h-screen bg-ivory p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-deep-moss">
        ...
        <div className="bg-soft-sage border-2 border-deep-moss p-4 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p>
                <strong>Active Context:</strong> {activeContext || 'None'}
              </p>
              <p>
        ...
        <div className="bg-soft-sage border-2 border-deep-moss p-4 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p>
                <strong>Loading Orgs:</strong> {isLoadingOrgs ? 'Yes' : 'No'}
              </p>
              <p>
                <strong>Active Org ID:</strong> {activeOrgId || 'None'}
              </p>
              <p>
                <strong>Organizations Count:</strong> {userOrganizations.length}
              </p>
            </div>
