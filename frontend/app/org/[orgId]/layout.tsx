        ...
        >
          <div className="p-4">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href={`/org/${orgId}/verification`}>
                <div className="flex items-center gap-3 px-4 py-3 border-2 border-transparent hover:bg-ivory hover:border-deep-moss hover:shadow-brutal hover:-translate-y-0.5 transition-all">
                  ...
                  <span className="font-bold text-deep-moss">Verification</span>
                </div>
              </Link>
            ...
            <div className="mt-auto pt-6">
              <SignOutButton className="flex items-center gap-3 w-full px-4 py-3 border-2 border-deep-moss bg-ivory hover:bg-red-100 hover:shadow-brutal hover:-translate-y-0.5 transition-all">
                <LogOut size={20} className="text-deep-moss" />
